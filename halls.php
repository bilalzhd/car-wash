                    ...
                    <div class="max-w-5xl mx-auto border-gray-900/10 pb-0 md:pb-12">
                        <div class="mt-10 gap-x-6 space-y-6">
                            ...
                            <div>
                                ...
                                <div class="mt-2">
                                    <input disabled class="px-4 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" type="text" name="date" id="date" required>
                                </div>
                            </div>
                        </div>
                    </div>
