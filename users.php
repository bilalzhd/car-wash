...
<?php if ($submitted || $error) { ?>
    <div class="<?php echo $submitted ? 'bg-green-500' : 'bg-red-500' ?> alert rounded-b text-white px-4 py-3 shadow-md text-xl" role="alert">
        <div class="flex items-center">
            ...
            <div>
                <p class="mx-4"><?php echo $error ? "Username already exists!" : "User has been added successfully!" ?></p>
            </div>
        </div>
    </div>
<?php } ?>
                ...
                <div class="max-w-5xl mx-auto border-gray-900/10 pb-12">
                    <div class="mt-10 px-5 md:px-0 md:flex justify-center items-center gap-x-6 gap-y-4">
                        <div class="mb-4 md:mb-0">
                            <label for="name" class="block text-xl font-medium leading-6 text-gray-900">Username</label>
                            <div class="mt-2">
                                <input class="px-4 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" type="text" name="username" id="name" placeholder="Enter Username" required>
                        ...
                        <div class="sm:col-span-12 flex items-end">
                            <button name="add_user" class="mt-[27.5px] hover:bg-indigo-700 transition-all duration-300 bg-indigo-500 w-full text-white px-4 py-2 rounded-lg">Add User</button>
                        </div>
                    </div>
                </div>
            </form>
            <div class="bg-white container shadow-lg rounded-md p-5 md:p-10 max-w-[60rem] mx-auto">
                <h1 class="text-4xl text-center font-bold mb-4">Users List</h1>
                        ...
                        <tbody>
                            ...
                            ?>
                                ...
                                <select style="display: none" id="edit_role" name="edit_role" class="editInput min-w-[200px] px-4 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" required>
                                        ...
                                        <option value="1" <?php echo $user['role'] == 1 ? 'selected' : "" ?>>Shopkeeper</option>
                                        <option value="2" s<?php echo $user['role'] == 2 ? 'selected' : "" ?>>Manager</option>
                                    </select>
                                </td>
                                <td class="w-1/4">
        ...
        <div class="">
            <div class="text-center p-5 flex-auto justify-center">
                ...
                <h2 class="text-xl font-bold py-4 ">Are you sure?</h3>
                    <p class="text-sm text-gray-500 px-8">Do you really want to delete the user?
            ...
            <div class="p-3  mt-2 text-center space-x-4 md:block">
                ...
                <button name="delete_user" type="submit" class="mb-2 md:mb-0 bg-indigo-500 border-indigo-500 px-5 py-2 text-sm shadow-sm font-medium tracking-wider text-white rounded-full hover:shadow-lg hover:bg-indigo-700">Save Changes</button>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="">
            <div class="p-5 flex-auto">
                <div class="text-indigo-500 flex w-full flex-col items-center space-y-4">
                    ...
                    <h3 class="text-4xl font-bold text-center">Edit User</h3>
                </div>
                <form method="POST" action="?" class="overflow-y-auto">
