                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        if ($role == 0) {
                            ...
                            <a href="http://localhost/car-wash/users.php" class="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Users</a>
                            <a href="http://localhost/car-wash/halls.php" class="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Halls</a>';
                        }
                        ?>
                    </div>
                </div>
            ...
            <div class="hidden md:block">
                <div class="ml-4 flex items-center md:ml-6">
                    ...
                    <div class="relative ml-3">
                        <div>
                            <a href="http://localhost/car-wash/logout.php">
...
<header class="bg-white shadow">
    <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        ...
        <?php
        if (isset($totalCars)) {
            echo '<h2 class="text-3xl font-bold tracking-tight text-gray-900">Total Cars: ' . $totalCars . '</h2>';
        }
        ?>
    </div>
</header>
